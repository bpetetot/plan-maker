...
> longer drops the Room area: a second, independent mark — `areaSilenced` — does
> that, and neither touches the other. The rule this ADR sets is unchanged and now
> holds for both marks — one stored carrier per room, one reconciliation, one law.
